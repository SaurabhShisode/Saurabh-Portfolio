...
export default function ContactSection({ state, handleSubmit }: ContactProps) {
  return (
    <section id="contact" className="pb-20 bg-[#0d1117] text-white font-inter">
      ...
      <div className="max-w-3xl mx-auto bg-[#121924] border border-[#2d384d] p-10 rounded-2xl shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="text-center">
              <button
                ...
                className="px-10 py-3 bg-[#caa9d3] text-black rounded-xl font-bold text-lg hover:bg-white transition-all duration-300 cursor-pointer"
              >
